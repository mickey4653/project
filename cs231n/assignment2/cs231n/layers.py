...
def batchnorm_forward(x, gamma, beta, bn_param):
    ...
    if mode == "train":
        ...
        # compute norm and get the ouput , store in cache
...
def batchnorm_backward(dout, cache):
    ...
    ###########################################################################
    # *****START OF YOUR CODE (DO NOT DELETE/MODIFY THIS LINE)*****
    # get Upstream derivatives shape
    N, D = dout.shape
...
def batchnorm_backward_alt(dout, cache):
    ...
    xhat, gamma, xmu, ivar, sqrtvar, var, eps = cache
    dxhat = dout * gamma
    # After computing the gradient with respect to the centered inputs, you should be able to compute gradients 
