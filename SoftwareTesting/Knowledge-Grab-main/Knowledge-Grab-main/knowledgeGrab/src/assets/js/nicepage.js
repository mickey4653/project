                ...
                Carousel = function() {
                    ...
                    return e.next = function t() { if (!this._isSliding) this._slide(_) }, e.nextWhenVisible = function t() { var e = s.default(this._element); if (!document.hidden && e.is(":visible") && "hidden" !== e.css("visibility")) this.next() }, e.prev = function t() { if (!this._isSliding) this._slide(x) }, e.pause = function t(e) {
                        ...
                        if (this._touchSupported) {
                            ...
                            else s.default(this._element).on(O, function(t) { return i(t) }), s.default(this._element).on(L, function(t) { return move(t) }), s.default(this._element).on(F, function(t) { return n(t) })
                        }
            ...
            return function(template, t, items, e) {
                ...
                var l = function() { return { x: 0, y: 0 } },
                    ...
                    Bt = {
                        ...
                        setScrollOffset: function(t, e) { O.x = t, J = O.y = e, ft("updateScrollOffset", O) },
                    ...
                    ti = function(t) {
                        if (!("mousedown" === t.type && t.button > 0)) {
                            ...
                            if (!oe || "mousedown" !== t.type) {
                                ...
                                var o = Qe(t),
                                    a = o.length;
                                if (ge = null, Ht(), !le || 1 === a) le = Ie = true, i.bind(window, w, n), ie = Le = Ee = ne = ve = ce = ue = fe = false, Ae = null, ft("firstTouchStart", o), wt(g, y), v.x = v.y = 0, wt(Kt, o[0]), wt(Gt, Kt), Qt.x = L.x * E, te = [{ x: Kt.x, y: Kt.y }], Zt = Vt = ct(), Tt(C, true), Re(), Ne();
                ...
                at("Tap", {
                    publicMethods: {
                        initTap: function() { ut("firstTouchStart", n.onTapStart), ut("touchRelease", n.onTapRelease), ut("destroy", function() { Li = {}, Oi = null }) },
        ...
        ! function(a, factory) {
            ...
            return function(t, e) {
                var i = this,
                    ...
                    L = function() {
                        if (h = !h, !h) O(), setTimeout(function() { if (!h) e.addClass(p, "pswp__share-modal--fade-in") }, 30);
                        else e.removeClass(p, "pswp__share-modal--fade-in"), setTimeout(function() { if (h) O() }, 300);
                        if (!h) M();
                        return false
                    },
        ...
        (function() {
            ...
            ! function(e, i, n) {
                ...
                o.prototype.refresh = function(t) {
                    ...
                    for (yt(), e = 0, o = t.length; e < o; e++) { var sk = Ot[t[e][F]]; if (sk !== n) at(sk), lt(sk) }
                    return At
                ...
                var tt = function() {
                    ...
                    rt = function() {
                        ...
                        if ($t || Ht !== t) { Nt = t > Ht ? "down" : t < Ht ? "up" : Nt, $t = false; var l = { curTop: t, lastTop: Ht, maxTop: Mt, direction: Nt }; if (false !== (Dt.beforerender && Dt.beforerender.call(At, l))) { if (ot(t, At.getScrollTop()), Yt && Lt) a.setStyle(Lt, "transform", "translate(0, " + -Qt + "px) " + Jt); if (Ht = t, Dt.render) Dt.render.call(At, l) } if (e) e.call(At, false) }
                        qt = i
                    },
                    at = function(t) {
